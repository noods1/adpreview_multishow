...
function TtPreview({ selectedImages = [], onProgressChange, progress, onProgressScrub }) {
  ...
  return (
    ...
    >
      ...
      {/* Gradient overlays */}
      <div className="absolute bg-gradient-to-b from-[rgba(0,0,0,0)] inset-[50.33%_0_0_0] to-[97.409%] to-[rgba(0,0,0,0.5)]" />
      <div className="absolute h-[56px] left-0 opacity-[0.32] right-0 top-0" style={{ backgroundImage: "linear-gradient(1.4941e-06deg, rgba(0, 0, 0, 0) 0%, rgba(0, 0, 0, 0.12) 30%, rgba(0, 0, 0, 0.25) 50%, rgba(0, 0, 0, 0.5) 70%, rgba(0, 0, 0, 0.75) 90%, rgba(0, 0, 0, 0.88) 96.25%, rgb(0, 0, 0) 100%)" }} />
    ...
    <div className="bg-white flex flex-col gap-3 items-start overflow-x-clip overflow-y-auto p-4 relative rounded-md shrink-0 w-full">
      ...
      <div className="flex gap-3 items-start relative shrink-0 w-full">
        <div className="basis-0 flex gap-3 grow items-center min-h-px min-w-px overflow-clip relative shrink-0">
          <span className="bg-[#e8fbf9] px-2 py-1 rounded text-xs font-tiktok-text font-medium text-[#009995]">Multi-show</span>
